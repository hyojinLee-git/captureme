module.exports={
    html:function(request){
        ...
        <body>
            ...
            <section id="main">
                <form action="http://localhost:8080/photoApplyPage/${request.params.id}" method="post">
                    <h1>사진 찍기 신청하기</h1>
                    <p>언제까지?</p>
                    <input type="date" name="time" required>
                    <p>어디서?</p>
                    <textarea name="location" required rows="1" cols="40" placeholder="사진 찍을 장소를 입력해주세요"></textarea>
                    <hr>
                    <br>
                    <input type="submit" value="사진 신청" onclick="checkDate()">
                </form>
            </section>
