...
module.exports={
    html: function(request,response,id){
        db.query(`SELECT detailSrc FROM test_image WHERE id=?`,[id],function(err,image){
            console.log(image[0].detailSrc);
           var data= `
            <html lang="en">
        <head>
            <meta charset="UTF-8">
            ...
            <section id="main">
                <div class="slideshow-container">
                    <div class="mySlides fade">
                        <img class="item image" src="./public/img/model_detail/model_detail2.jpg" style="height:100%">
                    ...
                    <div class="mySlides fade">
                        <img class="item image" src="" style="height:100%">
                        <div class="item description">
